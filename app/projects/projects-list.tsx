  ...
  return (
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {filtered.map((repo) => {
          const imagePath = `/assets/projects/${repo.name}.png`;
          ...
          return (
            ...
            >
              {/* Screenshot */}
              <div className="relative w-full h-40 bg-neutral-200 dark:bg-neutral-800 overflow-hidden">
                <Image
                  src={`/assets/projects/${repo.name}.png`}
